      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <Link
            ...
            className="group bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-indigo-300 hover:-translate-y-1"
          >
            <div className="flex flex-col items-start space-y-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-gray-800 group-hover:text-indigo-600 mb-1 transition-colors">
                  Medical History
                </h3>
                <p className="text-sm text-gray-500">Complete health records</p>
              </div>
              <div className="flex items-center space-x-2 text-indigo-600 font-medium group-hover:text-indigo-700">
